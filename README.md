...
Ve al costado izquierdo y selecciona los tres puntos de la tabla dedicada para los datos transformados. Para ver una previa de los datos haz click en "Preview Table"
